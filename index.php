  ...
  <script>
      function my_fun(str){
        ...
        xmlhttp.onreadystatechange = function(){
          ...
          xmlhttp.open("GET", "select-subcategorie2.php?value="+str, true);
          xmlhttp.send();
      }
    </script>
</head>
    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <?php  
                ...
                if(isset($_GET['categorie']) && isset($_GET['subcategorie'])){
                  ...
                  $text = "Noutati " . $row_cat['nume'] . " -> " . $row_subcat['nume'];
                }
      ?>
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Acasa</h1> <a class="btn btn-info ml-3 text-white" data-toggle="modal" data-target="#edit-categorie">Filtrare</a>
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="edit-video.php" class="mt-3">
            <input type="text" name="pagina" value="index.php" class="d-none">
