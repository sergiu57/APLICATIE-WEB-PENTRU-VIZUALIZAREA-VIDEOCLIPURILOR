...
<head>
  ...
  <title>SimVideo - Blacklist videoclipuri</title>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Blacklist videoclipuri</h1>
          </div>
          <a href="adaugare-videoclip-blacklist.php?id_minor=<?php echo $id_minor; ?>" class="btn btn-primary mb-4">Adauga videoclip</a>
          <?php if(isset($_GET['success'])): ?>
            <?php if($_GET['success'] == 'eliminare'): ?>
              <div class="alert alert-success">Videoclipul a fost eliminat cu succes din blacklist.</div>
            <?php endif ?>
          <?php endif ?>
          <div class="row">
            <?php  
              $sql_videoclipuri = "SELECT * FROM blacklist_videoclipuri WHERE id_utilizator = '$id_minor' ORDER BY id DESC";
            ...
            ?>
            <?php  
                  $id_video = $videoclip['id_videoclip'];
                  ...
                  <div class="article-details">
                    ...
                    <div class="article-user">
                      ...
                      <div class="user-cta text-center mt-3">
                        <form method="POST" action="blacklist-videoclipuri.php">
                          <input type="text" name="id_minor" value="<?php echo $id_minor; ?>" class="d-none">
                          <input type="text" name="id_videoclip" value="<?php echo $id_video; ?>" class="d-none">
                          <button class="btn btn-danger" type="submit" name="eliminare_blacklist_videoclip">Eliminare</button>
                        </form>
                      </div>
                    </div>
                  </div>
