...
var statistics_chart = document.getElementById("dayChart").getContext('2d');
var dayChart = new Chart(statistics_chart, {
  type: 'line',
  data: {
...
var statistics_chart = document.getElementById("monthChart").getContext('2d');
var monthChart = new Chart(statistics_chart, {
  type: 'line',
  data: {
    labels: ["Ianuarie", "Februarie", "Martie", "Aprilie", "Mai", "Iunie"],
    datasets: [{
      label: 'Vizualizari',
      data: [640, 387, 530, 302, 430, 270],
      borderWidth: 5,
      borderColor: '#6777ef',
      backgroundColor: 'transparent',
      pointBackgroundColor: '#fff',
